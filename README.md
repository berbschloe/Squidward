...
[![CocoaPods](https://img.shields.io/badge/pod-v1.4.1-blue.svg)](https://cocoapods.org/pods/Squidward)
...
```swift
dependencies: [
    .package(url: "https://github.com/berbschloe/Squidward.git", from: "1.4.1")
]
```
